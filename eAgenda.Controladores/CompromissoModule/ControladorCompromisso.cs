...
namespace eAgenda.Controladores.CompromissoModule
{
    public class ControladorCompromisso : Controlador<Compromisso>
    {
        ...
        private string sqlVerificarHorarioOcupado =
            @"SELECT
                COUNT(*)
              FROM
                TBCOMPROMISSO
        ...
        private bool ValidarConflitoDeHorarios(DateTime data, TimeSpan horaInicio, TimeSpan horaTermino)
        {
            Dictionary<string, object> parametros = new Dictionary<string, object>();

            parametros.Add("DATA_INSERCAO", data);
            parametros.Add("HORA_INICIO_INSERCAO", horaInicio.Ticks);
            parametros.Add("HORA_TERMINO_INSERCAO", horaTermino.Ticks);
